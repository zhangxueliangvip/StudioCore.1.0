...
namespace Infrastructure.Utility
{
    ...
    public class IPCore
    {
        ...
        static IPCore()
        {
            string ipdatadir = string.Empty;
            try
            {
                ipdatadir = System.Web.HttpContext.Current.Server.MapPath("~");
            }
            catch { ipdatadir = System.AppDomain.CurrentDomain.BaseDirectory; }
            filePath = ipdatadir + "/ipdata.config";
        ...
        public static string GetIp
        {
            get
            {
                ...
                {
                    LOGCore.Trace(LOGCore.ST.Day, "【IPHelper】", ex.ToString());
                    return "127.0.0.1";
                }
            }
        }
        ...
        {
            if (string.IsNullOrWhiteSpace(ip) || ip.Length < 7 || ip.Length > 15) return false;
