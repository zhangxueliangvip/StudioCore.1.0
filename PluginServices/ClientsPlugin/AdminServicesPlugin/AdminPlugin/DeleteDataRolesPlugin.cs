...
{
    public class DeleteDataRolesPlugin : BasePluginCore, IDeleteDataRolesPlugin
    {

        public BaseResult DeleteDataRoles(string safetySecretKey, bool isUsable, string openId)
        {
            ...
            if (MenuManager.GetInstance.DeletedRoles(out string message, openId))
            {
