...
{
    public class SetPllocationRolesCheckPlugin : BasePluginCore, ISetPllocationRolesCheckPlugin
    {

        public BaseResult SetPllocationRolesCheck(string safetySecretKey, bool isUsable,AuthRequest entity)
        {
            ...
            if (!MenuManager.GetInstance.SetPllocationRolesCheck(entity))
            {
                return result;
            }
