...
{
    public class GetPageDataOperationsPlugin : BasePluginCore, IGetPageDataOperationsPlugin
    {
        public TBaseResult<OperationsQueryItem> GetPageDataOperations(OperationsQueryItem queryItem)
        {
            ...
            var result = new TBaseResult<OperationsQueryItem>()
            {
                Code = (int)EnumCore.CodeType.失败,
                Message = "系统错误",
                TData = new OperationsQueryItem()
            };
            ...
            var dt = MenuManager.GetInstance.GetPageDataOperations(queryItem);
