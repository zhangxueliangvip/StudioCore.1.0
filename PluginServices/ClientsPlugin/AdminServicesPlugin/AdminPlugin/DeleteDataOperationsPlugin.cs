...
{
    public class DeleteDataOperationsPlugin : BasePluginCore, IDeleteDataOperationsPlugin
    {

        public BaseResult DeleteDataOperations(string safetySecretKey, bool isUsable, string openId)
        {
            ...
            if (MenuManager.GetInstance.DeletedOperations(out string message, openId))
            {
