...
{
    public class DeleteDataPagesPlugin : BasePluginCore,IDeleteDataPagesPlugin
    {
        public BaseResult DeleteDataPages(string safetySecretKey, bool isUsable, string openId)
        {
            ...
            if (MenuManager.GetInstance.DeletedPages(out string message, openId))
            {
