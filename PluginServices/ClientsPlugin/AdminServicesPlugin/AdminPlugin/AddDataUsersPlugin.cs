...
{
    public class AddDataUsersPlugin : BasePluginCore,IAddDataUsersPlugin
    {
        public BaseResult AddDataUsers(UsersModels entity)
        {
            ...
            if (UsersManager.GetInstance.AddAndUpUsers(entity, out string message))
            {
