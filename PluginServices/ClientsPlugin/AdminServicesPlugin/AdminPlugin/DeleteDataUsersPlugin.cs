...
{
    public class DeleteDataUsersPlugin : BasePluginCore,IDeleteDataUsersPlugin
    {
        public BaseResult DeleteDataUsers(string safetySecretKey, bool isUsable, string openId)
        {
            ...
            if (UsersManager.GetInstance.DeletedUsers(out string message, openId))
            {
